...
class Trainer:
    ...
    def wsft_module(self, images, targets_p, targets_u, targets_u_true, epoch_idx):
        cfg = self.cfg
        ...
        for epoch_idx in range(num_epochs):
            ...
            for batch_idx in range(num_batches):
                ...
                if cfg.prec == "amp":
                    ...
                    with autocast():
                        loss, ure_loss, cr_loss, pseudo_label_acc = self.wsft_module(images, targets_p, targets_u, targets_u_true, epoch_idx)
    ...
    def save_feature(self):
        ...
        for batch in tqdm(data_loader, ascii=True):
            ...
            labels.append(label)
        print(output.shape)
        torch.save((features, labels), 'wsft_test_features.pth')
        ...
        for batch in tqdm(data_loader, ascii=True):
            ...
            labels.append(label)
        print(output.shape)
        torch.save((features, labels), 'wsft_train_features.pth')
